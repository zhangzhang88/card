...
export default function CardEditor({ template, showDate = true, showAuthor = true, showCount = true, customBgType, customBgColor, customBgGradient, cardWidth = 420, onSaveTemplate }) {
  ...
  // 内容框背景色
  const innerBg = `rgba(255,255,255,0.18)`;
